...
def run_trading_system():
    ...
    from src.ui.trading_dashboard import AlpineTradingDashboard
    from src.trading.trade_executor import TradingOrchestrator
    ...
    try:
        ...
        try:
            # Import and initialize Alpine Bot from archives
            from archives.old_versions.alpine_bot import AlpineBot
        ...
        try:
            # Import and initialize Volume Anomaly Bot from archives
            from archives.old_versions.volume_anom_bot import VolumeAnomBot
...
def run_connection_test():
    ...
    import asyncio
    from tests.unit.test_connection import test_bitget_connection
...
def main():
    ...
    if choice == "1":
        ...
        from src.ui.trading_dashboard import main as dashboard_main
        dashboard_main()
    elif choice == "3":
        run_connection_test()
    elif choice == "4":
        console.print("\n[bold #00FFB3]Starting Alpine Bot only...[/bold #00FFB3]")
        from archives.old_versions.alpine_bot import main as alpine_main
        alpine_main()
    elif choice == "5":
        console.print("\n[bold #00FFB3]Starting Volume Anomaly Bot only...[/bold #00FFB3]")
        from archives.old_versions.volume_anom_bot import main as volume_main
        volume_main()
    elif choice == "6":
