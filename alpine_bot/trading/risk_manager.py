...
class AlpineRiskManager:
    ...
    def can_open_position(self, symbol: str, side: str, size: float, price: float) -> Tuple[bool, str]:
        ...
        try:
            ...
            if len(self.active_positions) >= 20:  # Default max positions
    ...
    def calculate_position_size(self, symbol: str, price: float, risk_pct: float) -> float:
        """Calculate position size based on risk"""
        try:
            # Basic position sizing
            account_balance = 100.0  # Default for testing
    ...
    def get_risk_summary(self) -> Dict:
        ...
        return {
            ...
            'position_metrics': {
                ...
                'max_drawdown': self.total_drawdown
            },
            'daily_metrics': {
                'daily_pnl': self.daily_pnl
            },
